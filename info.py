...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "🎥 𝖳𝗂𝗍𝗅𝖾: <code><a href={url}>{title}  href={url}/releaseinfo>{year}</code></a>\n🎭 𝖦𝖾𝗇𝗋𝖾𝗌: {genres}\n📆 𝖱𝖾𝗅𝖾𝖺𝗌𝖾: <a href={url}/releaseinfo>{year}</a>\n🌟 𝖱𝖺𝗍𝗂𝗇𝗀: <a href={url}/ratings>{rating}</a> / 10\n<b>🔊 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾𝗌:</b> <a <code>{languages}</code></a>\n📀 𝖱𝗎𝗇𝖳𝗂𝗆𝖾: {runtime} Minutes\n<b>**© {message.chat.title}**</b>")
